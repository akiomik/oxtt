...
- Verified at the boundary values by `gain_is_0db_everywhere_when_amounts_are_zero` and `effective_amount_clamps_to_unit_range` (`crates/oxtt-dsp/src/dsp/compressor.rs`).
